...
public class consola {
    ...
    */
    ...
    public static float readCualquierFloat(int min, String mensaje){
        float iTemp = 0;
        while (true){
            try {
                System.out.print(mensaje);
...
//        char respuesta = Character.toLowerCase(readLine().charAt(0));
//        while (respuesta != 's' && respuesta != 'n'){
//            System.out.println("ERROR. vuelva ingresar la respuesta: ");
//            System.out.print("¿Desea continua? (S/N): ");
//            respuesta = Character.toLowerCase(readLine().charAt(0));
//        }
//        if (respuesta == 's'){
...
//    }
    ...
    */
    ...
    // Método genérico para leer cualquier tipo de dato
    public static <T> T readGeneric(String mensaje) {
        Scanner sc = new Scanner(System.in);
        System.out.print(mensaje);
        
        // Leemos la entrada del usuario como un String
        String input = sc.nextLine();
        
        // Determinamos el tipo de dato y convertimos la entrada
        try {
            // Si el tipo es Integer
            if (input.matches("-?\\d+")) {
                return (T) Integer.valueOf(input);
            }
            // Si el tipo es Double
            ...
            return null; // Si ocurre un error, retornamos null o puedes devolver un valor por defecto
        }
    }
